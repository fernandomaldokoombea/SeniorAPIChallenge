import api.helpers.PhotoServiceHelper;
...
import static api.constants.Endpoints.GET_NASA_PHOTOS_CURIOSITY;
import static api.helpers.PhotoServiceHelper.cameras;
...
public class TestNasaApi {
    ...
    public void RetrieveTheFirst10MarsPhotosMadeByCuriosityOn1000MartianSol() throws JsonProcessingException {
        ...
        System.out.println(first10photosCuriosity);

    }

    @Test(testName = "Retrieve the first 10 Mars photos made by \"Curiosity\" on Earth date equal to 1000 Martian sol.",  priority = 2)
